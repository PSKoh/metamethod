...
-   The `paste()` function creates the label by combining the "author" and "year_published" columns. The `sep` argument specifies the separator between the columns, whcich is set to ", " in this case. Hence, the label will be in the format "Author(s), Year_Published" (e.g., "Smith, 2020").
...
-   The `paste()` function creates the label by combining the "author" and "year_published" columns. The `sep` argument specifies the separator between the columns, whcich is set to ", " in this case. Hence, the label will be in the format "Author(s), Year" (e.g., "Smith, 2020").

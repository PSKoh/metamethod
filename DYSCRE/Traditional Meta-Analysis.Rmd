...
-   The `n1i` and `n2i` argument specify the columns for the sample sizes of each group

-   The `m1i` and `m2i` argument specify the columns for the means of each group.

-   The `sd1i` and `sd2i` argument specify the columns for the standard deviations of each group.
...
-   The `paste()` function creates the label by combining the "Paper" and "Study" columns, and the `sep` argument specifies the separator between the columns.
...
-   The `x` argument specifies the horizontal arrangement of the columns and the `y` argument specifies the vertical arrangement of the columns.
...
-   The `x` and `y` arguments in the `text()` function adjust the position of the headers.
...
-   The `c()` function inside the `text()` function creates a vector of x-positions, where the labels "Dslx" and "Ctrl" will be placed. The first x-value (-3.8) determines the horizontal position of the "Dslx" label, and the second x-value (-3.3) positions the "Ctrl" label. 

...
-   The `paste()` function creates the label by combining the "author" and "year_published" columns, and the `sep` argument specifies the separator between the columns.
